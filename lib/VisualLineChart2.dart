...
class VisualLineChart2 extends StatefulWidget {
  const VisualLineChart2({Key? key}) : super(key: key);

  @override
  _VisualLineChartState2 createState() => _VisualLineChartState2();
}

class _VisualLineChartState2 extends State<VisualLineChart2> {
